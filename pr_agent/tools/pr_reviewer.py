...
class PRReviewer:
    ...
    def __init__(self, pr_url: str, is_answer: bool = False, is_auto: bool = False, args: list = None,
        ...
        self.vars = {
            ...
            "num_max_findings": get_settings().pr_reviewer.get("num_max_findings", 15),
            "require_score": get_settings().pr_reviewer.get("require_score_review", False),
            "require_tests": get_settings().pr_reviewer.get("require_tests_review", True),
            "require_estimate_effort_to_review": get_settings().pr_reviewer.get("require_estimate_effort_to_review", True),
            'require_can_be_split_review': get_settings().pr_reviewer.get("require_can_be_split_review", False),
            'require_security_review': get_settings().pr_reviewer.get("require_security_review", True),

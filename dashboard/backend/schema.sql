...
CREATE TABLE operations (
	...
	warnings_count INTEGER, job_id VARCHAR, operation_type VARCHAR, result_data JSON, model_used VARCHAR, input_tokens INTEGER, output_tokens INTEGER, estimated_dev_hours_saved FLOAT, 
	PRIMARY KEY (id)
);
...
CREATE TABLE log_entries (
	...
	received_at VARCHAR, job_id VARCHAR, operation_id VARCHAR, 
	PRIMARY KEY (id)
);
...
CREATE TABLE repositories (
	...
	created_at DATETIME, 
	updated_at DATETIME, 
	last_activity DATETIME, github_token VARCHAR, azure_pat VARCHAR, runner_status VARCHAR, runner_last_seen DATETIME, runner_error VARCHAR, has_pr_agent_config BOOLEAN DEFAULT FALSE, config_last_checked DATETIME, effective_config JSON, has_workflow_config BOOLEAN DEFAULT FALSE, 
	PRIMARY KEY (id)
);
...
CREATE TABLE metrics_aggregate (
	...
	total_estimated_dev_hours FLOAT, 
	model_usage JSON, 
	last_updated DATETIME, 
	PRIMARY KEY (id)
);

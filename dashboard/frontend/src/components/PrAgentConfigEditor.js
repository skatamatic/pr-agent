  ...
  const configSections = {
    ...
    pr_filters: {
      ...
      fields: [
        ...
        { key: 'pr_filters.max_lines_changed', label: 'Max lines changed', type: 'number', min: 0, max: 100000, description: 'Terminate processing of PRs exceeding this many lines changed and post explanatory comment (0 = disabled)' },
